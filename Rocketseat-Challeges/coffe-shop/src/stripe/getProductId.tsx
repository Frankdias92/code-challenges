...
// export async function GetProductId({ product }: ProductProps ) {
//     // const [loading, setLoading] = useState(false)
    
//     console.log('TESTS PRODUCT', product)
//     const res = await stripe.products.retrieve(product.id, {
...
//                         <BtnBuyProduct onClick={handleBuyProduct}  />
